...
{
	class VarInt : public NonCopyable
	{
		public:
		...
		public:
			VarInt() = default;
			~VarInt() override = default;

		public:
			[[nodiscard]] static std::expected<std::int32_t, Error> Read(ByteBuffer& buffer) noexcept;
			[[nodiscard]] static std::expected<std::int64_t, Error> ReadLong(ByteBuffer& buffer) noexcept;
