...
// 	buffer.Clear(); \
// 	Nb::Network::VarInt::Write(value, buffer); \
// 	std::cout << buffer << std::endl; \
// 	{ \
// 		auto resul = Nb::Network::VarInt::Read(buffer); \
...
// 	buffer.Clear(); \
// 	Nb::Network::VarInt::WriteLong(value, buffer); \
// 	std::cout << buffer << std::endl; \
// 	{ \
// 		auto resul = Nb::Network::VarInt::ReadLong(buffer); \
// 		if (!resul || *resul != value) { \
